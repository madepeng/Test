...
public class Client {
	 public static void main(String args[]) {  
	        ...
	        Class test[] = new Class[]{AbstractUserDAO.class};
	...
	//动态创建代理对象，用于代理一个AbstractDocumentDAO类型的真实主题对象  
	        proxy_new = (AbstractDocumentDAO)Proxy.newProxyInstance(DocumentDAO.class.getClassLoader(), new Class[]{AbstractDocumentDAO.class}, handler);  
